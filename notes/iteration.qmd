...
:::{.callout-warning}
A nested for loop is more than acceptable in other languages. If you find your self writing a nest for loop in R, you should really consider using the `apply` family or the `purrr` package.
:::
