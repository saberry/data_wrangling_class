...
Once you have your data subsetted, plot where each of those accidents happened. Do not try to plot this data without subsetting it first. It will take forever to plot and you'll probably crash your session -- in other words, it will be a bad time.
