...
You have deadly accidents, accidents with a lot of evacuations, and the union between them. Now you are going to plot the location of each crash in the union between deadly and high evacuation.
...
Check out the `Total.Damage.Cost` variable -- you will use it, but it will need to be changed first!

You need to create new columns to capture the cost per person killed/injured.
...
Color each of the crashes by the total damage cost and person killed/injured ratio

Here is some code to get you going with your plot, but take time to tidy up your data first! If you try to plot everything, you will have a bad time!
