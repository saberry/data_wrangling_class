...
You can also read a file from the web. Here is a table of *Fatal Occupational Injuries*: https://download.bls.gov/pub/time.series/fw/fw.event

```{r}
read.delim("https://download.bls.gov/pub/time.series/fw/fw.event")
```
